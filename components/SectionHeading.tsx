...
type Props = {
  ...
  title: string;
  /** Small accent label above the title, e.g. "Who I am". Falls back to the title. */
  kicker?: string;
...
export default function SectionHeading({ title, kicker, intro, centered }: Props) {
  return (
    <Reveal className={centered ? "mx-auto max-w-2xl text-center" : "max-w-2xl"}>
      {/* Small decorative accent bar + kicker label */}
