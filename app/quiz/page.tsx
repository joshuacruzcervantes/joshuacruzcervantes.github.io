 ...
 * QUIZ HUB — /quiz
 * ----------------
 * A grid of every entry in `content.quizzes`. Each card links to a
 * self-contained HTML quiz that lives in /public and opens in a new tab.
 *
 * To add a new quiz:
 *   1. Drop the self-contained HTML file into /public (e.g. /public/foo.html).
 *   2. Append an entry to `content.quizzes` in lib/content.ts.
